...
public  class ProductBacklog extends CommonConcept implements Serializable {
  ...
  @ManyToOne
  @JoinColumn(name = "productbacklogdefinition_id")
  private ProductBacklogDefinition productbacklogdefinition;

  @OneToMany(cascade = {CascadeType.ALL}, orphanRemoval = true, mappedBy = "productbacklog")
  @Builder.Default
  ...
  public boolean equals(Object o) {
        ...
        ProductBacklog elem = (ProductBacklog) o;
